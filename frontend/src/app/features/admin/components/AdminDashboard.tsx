    ...
    <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Oldest: {stats.approval_performance.oldest_pending_days} days
                </p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Complete metadata</p>
              </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm space-y-2">
              <p>
                <strong>{stats.geographic_analytics.unique_locations}</strong>{" "}
                unique locations
              </p>
              <p>
                <strong>{stats.geographic_analytics.geotagged_datasets}</strong>{" "}
                geotagged datasets
              </p>
            </div>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          />
          <ProgressBar
            percentage={stats.data_quality_metrics.tag_completeness.percentage}
            color="bg-purple-500"
          ...
          />
          <ProgressBar
            percentage={stats.data_quality_metrics.complete_metadata.percentage}
            color="bg-red-500"
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border-t pt-4">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {stats.download_analytics.datasets_with_downloads} datasets have
                downloads
              </p>
            </div>
          </div>

...
// Mock data for the profile page - this will now be part of the component's state
const initialMockProfileData: ProfileData = {
  fullName: "Dr. Jane Doe",
  title: "Senior Researcher | AI & Machine Learning",
  bio: "Passionate about advancing the field of artificial intelligence and fostering collaborative research. Experienced in developing novel machine learning models and applying them to real-world problems.",
  profilePictureUrl: "https://via.placeholder.com/150",
  coverPhotoUrl: "https://via.placeholder.com/1000x300",
  aboutMe:
    "I am a dedicated researcher with over 10 years of experience in the field of AI. My work focuses on natural language processing, computer vision, and reinforcement learning. I believe in the power of open data and collaboration to accelerate scientific discovery. In my free time, I enjoy hiking and contributing to open-source projects.",
  skills: [
    "Machine Learning",
    "Deep Learning",
    "Python",
  ...
  projects: [
    {
      id: 1,
      name: "Sentiment Analysis of Social Media Trends",
      description:
        "Developed a deep learning model to analyze and predict public sentiment from Twitter data.",
      link: "#",
    },
    {
      id: 2,
      name: "Automated Medical Image Diagnosis",
      description:
        "Collaborated on a project to build an AI system for detecting anomalies in medical scans.",
      link: "#",
    },
  ],
  contact: {
...
const ProfilePage = () => {
  ...
  const handleSaveProfile = (updatedData: ProfileData) => {
    ...
    console.log("Profile updated on page:", updatedData);
  };

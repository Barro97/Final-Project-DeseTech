...
export const UploaderProfile: React.FC<UploaderProfileProps> = ({
  ...
  return (
    <button
      ...
      className={`flex items-center group hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg p-3 -m-3 transition-all duration-200 hover:shadow-md ${className}`}
    ...
    >
      ...
      <div className="relative mr-4 flex-shrink-0">
        {uploaderProfile.profilePictureUrl ? (
          <img
            ...
            className="w-12 h-12 rounded-full object-cover ring-2 ring-white dark:ring-gray-800 shadow-sm group-hover:ring-blue-200 dark:group-hover:ring-blue-600 transition-all"
          />
        ) : (
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-sm font-semibold ring-2 ring-white dark:ring-gray-800 shadow-sm group-hover:ring-blue-200 dark:group-hover:ring-blue-600 transition-all">
      ...
      <div className="flex flex-col items-start text-left">
        <div className="flex items-center">
          <span className="text-base font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
